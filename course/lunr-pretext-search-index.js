...
},
{
  ...
  "number": "2",
  "title": "",
  "body": "  Give the sets and , find the simplified forms for and .   =    =   To describe a set with a single value such as 4, write {4} . To describe an empty set, write {} .              a1+delta1          a2+delta2   Set.prototype.menv = v._mobjs; v.left1 = RNG.randInt(0,1); v.right1 = RNG.randInt(0,1); v.interval1 = new Set([new Interval(v.a1, v.b1, [v.left1, v.right1])]); v.left2 = RNG.randInt(0,1); v.right2 = RNG.randInt(0,1); v.interval2 = new Set([new Interval(v.a2, v.b2, [v.left2, v.right2])]); v.unionSet = v.interval1.union(v.interval2); v.intersectSet = v.interval1.intersect(v.interval2);      union_blank.compare(unionSet)      intersect_blank.compare(intersectSet)     "
},
{
